<?php
    ...
    */
        ...
        private function packets()
	{
	  ...
	  if( isset($ns_id) )
	  {
	    $packets = new NuPacketInboxNSQuery($user->id, $ns_id, $this->call->page, $this->call->count);
	  }
	  else
	  {
	    $packets = new NuPacketInboxQuery($user->id, $this->call->page, $this->call->count);
	  }
	  ...
	  NuSelect::eventFilter( $packets, 'nu_fmp_inbox_query', array("fields"=>"premerge", "joins"=>"postmerge", "conditions"=>"postmerge") );
